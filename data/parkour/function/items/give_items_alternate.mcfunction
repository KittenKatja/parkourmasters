...
execute unless items entity @s hotbar.7 carrot_on_a_stick[custom_data~{item:"spawn"}] run clear @s carrot_on_a_stick[custom_data={item:"spawn"}]
execute unless items entity @s hotbar.8 carrot_on_a_stick[custom_data~{item:"settings"}] run clear @s carrot_on_a_stick[custom_data={item:"settings"}]
execute unless items entity @s hotbar.3 carrot_on_a_stick[custom_data~{item:"kill"}] run clear @s carrot_on_a_stick[custom_data={item:"kill"}]
execute unless items entity @s hotbar.6 carrot_on_a_stick[custom_data~{item:"restart"}] run clear @s carrot_on_a_stick[custom_data={item:"restart"}]
execute unless items entity @s hotbar.3 carrot_on_a_stick[custom_data~{item:"featured"}] run clear @s carrot_on_a_stick[custom_data={item:"featured"}]

tp @s -999 46 -100031 0 0
spawnpoint @s -999 46 -100031 0 0
clear @a[tag=!nodelete] *[minecraft:custom_data~{map:easy}]
function parkour:reset

data modify storage stopwatch:player_data map_id set value "easy"
data modify storage stopwatch:player_data name set value "ᴇᴀѕʏ ᴍᴀᴄᴇ ʀᴜɴ"

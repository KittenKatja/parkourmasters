tp @s 99998 41 -999982 0 0
spawnpoint @s 99998 41 -999982 0 0
clear @a[tag=!nodelete] *[minecraft:custom_data~{map:mountain}]
function parkour:reset

data modify storage stopwatch:player_data map_id set value "mountain"
data modify storage stopwatch:player_data name set value "ᴍᴀᴄᴇ ᴍᴏᴜɴᴛᴀɪɴ (ʜᴀʀᴅ)"

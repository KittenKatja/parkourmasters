tp @s 8000 36 100 0 0
spawnpoint @s 8000 36 100 0 0
clear @a[tag=!nodelete] *[minecraft:custom_data~{map:white}]
function parkour:reset

data modify storage stopwatch:player_data map_id set value "white"
data modify storage stopwatch:player_data name set value "Hard White Run"

tp @s 34585 45.376 -23405 180 0
spawnpoint @s 34585 46 -23405 180 0
clear @a[tag=!nodelete] *[minecraft:custom_data~{map:frost}]
function parkour:reset

data modify storage stopwatch:player_data map_id set value "frost"
data modify storage stopwatch:player_data name set value "Frost Chasm"

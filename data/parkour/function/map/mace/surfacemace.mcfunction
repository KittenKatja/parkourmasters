...
tp @s 7000 65 100 90 0
spawnpoint @s 7000 65 100 90 0
clear @a[tag=!nodelete] *[minecraft:custom_data~{map:surfacemace}]
function parkour:reset

data modify storage stopwatch:player_data map_id set value "surfacemace"
data modify storage stopwatch:player_data name set value "Surface Mace"

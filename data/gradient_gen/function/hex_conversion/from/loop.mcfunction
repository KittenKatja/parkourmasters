...
function gradient_gen:hex_conversion/from/loop/exponent
...
execute if score min hex_conversion matches 0.. run function gradient_gen:hex_conversion/from/loop with storage gradient_gen:hex_conversion temp